...
augroup vimrcEx
  ...
  autocmd FileType python,jade set ai sw=4 sts=4 et
...
autocmd BufNewFile *.cc,*.sh,*.js exec ":call SetTitle()"
"新建.cc,.java,.sh,
...
if &filetype == 'sh'
    ...
    call append(line("."),"\#########################################################################")
    call append(line(".")+1, "\# Author: sswxyz (sswxyza@gmail.com)")
    ...
    call setline(1, "/*************************************************************************")
    call append(line("."), " Author: sswxyz (sswxyza@gmail.com)")
